...
#define INT_CLASS(Name)                                                      \
   public:                                                                   \
    Name() : IntegerType(BuiltinType::IntegerTypeID::INT) { init_type(); }   \
    Name(CV_Qual _cv_qual, bool _is_static, uint32_t _align)                 \
        : IntegerType(BuiltinType::IntegerTypeID::INT, _cv_qual, _is_static, \
                      _align) {                                              \
        init_type();                                                         \
    }                                                                        \
    void dbg_dump();                                                         \
